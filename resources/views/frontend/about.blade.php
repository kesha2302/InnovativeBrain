...
<br>
                        <img class="img-fluid w-70 h-70" src="frontend/img/ab.jpg" alt=""
                        style="border-radius: 15px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.3); transition: transform 0.3s ease-in-out;">
